...
public class AppIntroduction extends AppCompatActivity {
    ...
    private String colorNightOrDay;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final AlertDialog.Builder builder=new AlertDialog.Builder(AppIntroduction.this);
        ...
        builder.setSingleChoiceItems(arr, -1, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                if(i==0){
                    ...
                    Toast.makeText(AppIntroduction.this, "ur", Toast.LENGTH_SHORT).show();
                    ...
                    //LanguageManager.setNewLocale(MainActivity.this, LanguageManager.LANGUAGE_KEY_ZH);
